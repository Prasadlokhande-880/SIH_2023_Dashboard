...
const Contacts = () => {
  ...
  const saveUser = () => {
    ...
    if (!params.factDate) {
      showMessage("Date Filled is required.", "error");
      return true;
    }
    if (!params.role) {
  ...
  return (
    <div>
      <div className="flex items-center justify-between flex-wrap gap-3">
        <h2 className="text-xl">Filed Cases</h2>
                ...
                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                  ...
                  <div className="p-5">
                    <form>
                      ...
                      <div className="mb-5">
                        <label htmlFor="number">Date Filled Number</label>
                        <input
                          id="factDate"
                          type="text"
                          placeholder="Enter Date Filled Number"
                          className="form-input"
